...
set :application, "gigs"

role :app, "gigs.adammiribyan.com"
role :web, "gigs.adammiribyan.com"
role :db,  "gigs.adammiribyan.com", :primary => true

set :scm, "git"
set :repository,  "git@github.com:adammiribyan/gigs.git"
